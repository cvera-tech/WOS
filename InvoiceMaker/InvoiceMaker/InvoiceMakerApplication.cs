...
namespace InvoiceMaker
{
    public class InvoiceMakerApplication : HttpApplication
    {
        ...
        protected void HandleAcquireRequestState(object sender, EventArgs e)
        {
            Debug.WriteLine("HandleAcquireRequestState");
        }

        protected void HandlePostAcquireRequestState(object sender, EventArgs e)
        {
            Debug.WriteLine("HandlePostAcquireRequestState");
        }

        protected void HandlePreRequestHandlerExecute(object sender, EventArgs e)
        {
            Debug.WriteLine("HandlePreRequestHandlerExecute");
        }

        protected void HandlePostRequestHandlerExecute(object sender, EventArgs e)
        {
            Debug.WriteLine("HandlePostRequestHandlerExecute");
        }

        protected void HandleReleaseRequestState(object sender, EventArgs e)
        {
            Debug.WriteLine("HandleReleaseRequestState");
        }

        protected void HandlePostReleaseRequestState(object sender, EventArgs e)
        {
            Debug.WriteLine("HandlePostReleaseRequestState");
        }

        protected void HandleUpdateRequestCache(object sender, EventArgs e)
        {
            Debug.WriteLine("HandleUpdateRequestCache");
        }

        protected void HandlePostUpdateRequestCache(object sender, EventArgs e)
        {
            Debug.WriteLine("HandlePostUpdateRequestCache");
        }

        protected void HandleLogRequest(object sender, EventArgs e)
        {
            Debug.WriteLine("HandleLogRequest");
        }

        protected void HandlePostLogRequest(object sender, EventArgs e)
        {
